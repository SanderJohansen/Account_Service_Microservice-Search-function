...
public class SearchLogic implements ISearchLogic {
    ...
    public Response getMultipleCannabis(String SearchTerm) throws ICannabisDAO.DALException, SQLException {
        //Make a call to the DAO, to get the cannabis from the database
        Cannabis responseCannabis = dao.getMultipleCannabis(SearchTerm);
